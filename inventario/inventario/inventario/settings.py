...
INSTALLED_APPS = [
    ...
    'allauth',
    'allauth.account',
    'allauth.socialaccount',  # Opcional, pero requerido por allauth
    'bootstrap4',
    'crispy_forms',
    'crispy_bootstrap4',
    'productos',
...
# Usar PostgreSQL si DATABASE_HOST está definido (Docker), sino SQLite (desarrollo local)
if os.environ.get('DATABASE_HOST'):
    DATABASES = {
        'default': {
            ...
            'PASSWORD': os.environ.get('DATABASE_PASSWORD', 'inventario_pass'),
...
ACCOUNT_SIGNUP_ENABLED = False  # Deshabilitar registro
